...
func TestMessageService(t *testing.T) {
    ...
    t.Run("GetMessagesByChatRoom", func(t *testing.T) {
        ...
        msg1 := &model.Message{Content: "msg1", UserID: 1, ChatRoomID: 100, CreatedAt: time.Now().Add(-time.Hour)}
        msg2 := &model.Message{Content: "msg2", UserID: 1, ChatRoomID: 100, CreatedAt: time.Now()}
